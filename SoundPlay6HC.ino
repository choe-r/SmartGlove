...
//A AND B ARE just to test code
int A=1 ;
int B=3;

#define player1Pin A0??
#define player2Pin???

//Call on function detMove which will return an int
//which corresponds to gun, reload, shield move
int play1= detMove(player1Pin);
int play2= detMove(player2Pin);
...
//to input a move
//write this subfn later:
//playWhichSound (int plyrIntMove) { 
//move made will determine which move is made
